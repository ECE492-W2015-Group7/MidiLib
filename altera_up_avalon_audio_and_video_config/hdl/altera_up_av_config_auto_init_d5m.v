...
begin
	...
	2		:	data	<= {8'hBA, 8'h09, 16'h07c0}; // Exposure
...
`endif
	...
	20		:	data	<= {8'hBA, 8'h03, 16'h0797}; // set row size	
	21		:	data	<= {8'hBA, 8'h04, 16'h0A1F}; // set column size
	22		:	data	<= {8'hBA, 8'h22, 16'h0000}; // set row mode in bin mode
	23		:	data	<= {8'hBA, 8'h23, 16'h0000}; // set column mode in bin mode
